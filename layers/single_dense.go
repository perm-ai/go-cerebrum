...
func NewSingleDense(inputUnit int, outputUnit int, activation activations.Activation, useActivation bool, utils utility.Utils) SingleDense {
	...
	return SingleDense{inputUnit, outputUnit, weights, bias, activation, useActivation, utils, true}

}

func (model SingleDense) Forward(input *ckks.Ciphertext) (ckks.Ciphertext, ckks.Ciphertext) {
...
func (model SingleDense) Backward(input *ckks.Ciphertext, output *ckks.Ciphertext, gradient ckks.Ciphertext, nextLayerTransposedWeight []ckks.Ciphertext, lr float64) NeuralNetworkGradient {
...
func (d *SingleDense) UpdateGradient(gradient NeuralNetworkGradient) {
